...
<head>
    <meta charset="utf-8">
    <title>Edit Reservation - NewRest</title>
                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Edit Reservation #<?= $reservation['id'] ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Update Your Booking</h1>
                </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" type="submit">
                                            <i class="fa fa-save me-2"></i>Update Reservation
                                        </button>
                                    </div>
                                    <div class="col-12">
                                        <a href="index.php?controller=reservation&action=manage" 
                                           class="btn btn-secondary w-100 py-3">
                                            <i class="fa fa-arrow-left me-2"></i>Back to Reservations
                                        </a>
                                    </div>
                                </div>
                            </form>
