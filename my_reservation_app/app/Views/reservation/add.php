...
<head>
    <meta charset="utf-8">
    <title>Add Reservation - NewRest</title>
        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Add Reservation</h1>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Book Your Meal</h1>
                </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            ...
                                            <label for="contents">Contents (for lunch/dinner)</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
