...
<head>
    <meta charset="utf-8">
    <title><?= htmlspecialchars($day) ?> Menu - NewRest</title>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5"><?= htmlspecialchars($day) ?>'s Special Items</h1>
                </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                ...
                                                <span class="text-primary">Mad<?= number_format($menuItem['price'], 2) ?></span>
                                            </h5>
                                            <small class="fst-italic"><?= htmlspecialchars($menuItem['meal_type']) ?></small>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach; ?>
